      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 md:mb-24">
          ...
          <h2 className="text-3xl md:text-5xl font-bold mt-4 mb-6">
            Smart sorting, simplified
          </h2>
          <p className="text-lg text-muted-foreground">
            Our technology integrates seamlessly into existing textile processing workflows, 
            adding intelligence without complexity.
          </p>
        </div>
            ...
            {steps.map((step, index) => (
              <div key={index} className="relative">
                ...
                {index < steps.length - 1 && (
                  <div className="hidden md:block absolute top-12 left-[calc(100%-1rem)] z-10">
          ...
          <div className="bg-card rounded-2xl p-8 md:p-12 shadow-card border border-border/50 text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                { value: "5k+", label: "Items/hour" },
                { value: "99%", label: "Uptime" },
                { value: "<1s", label: "Per item" },
              ].map((stat, index) => (
