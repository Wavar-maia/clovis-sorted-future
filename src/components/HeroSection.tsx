  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold mb-6 animate-fade-up leading-tight">
            ...
            <span className="text-gradient">circular value</span>
          </h1>

          {/* Subheadline */}
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 animate-fade-up-delay leading-relaxed">
            We use advanced AI to sort post-consumer textiles at unprecedented speed and precision, 
            unlocking reuse potential and making recycling economically viable.
          </p>
          ...
          {/* Stats Preview */}
          <div className="grid grid-cols-3 gap-4 md:gap-8 mt-16 md:mt-24 animate-fade-up-delay" style={{ animationDelay: "0.6s" }}>
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-muted-foreground mt-1">Faster sorting</div>
            </div>
            <div className="text-center">
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce">
        <button
          onClick={() => scrollToSection("what-we-do")}
          className="p-2 rounded-full bg-card/50 backdrop-blur-sm border border-border/50 hover:bg-card transition-colors"
        >
